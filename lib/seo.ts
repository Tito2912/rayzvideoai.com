...
export function getOpenGraphImage(meta: DocMeta): string {
  if (!meta.translationKey) return '/images/og-social.jpg';
  if (meta.translationKey === 'home' || meta.translationKey === 'blog_index') return '/images/og-social.jpg';
  if (meta.translationKey === 'blog_pictory') return '/images/og-pictory.jpg';
  if (meta.translationKey === 'blog_akool') return '/images/og-akool.jpg';
  if (meta.translationKey === 'blog_heygen') return '/images/og-heygen.jpg';
  if (meta.translationKey === 'blog_invideo') return '/images/og-invideo.jpg';
  return '/images/og-social.jpg';
}
